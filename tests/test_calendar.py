...
def test_lm2_formation_activates_only_after_penultimate_monthly_session():
    assert active_lm2_formation_date(pd.Timestamp("2026-08-27")) == pd.Timestamp(
        "2026-07-30"
    )
    assert active_lm2_formation_date(pd.Timestamp("2026-08-28")) == pd.Timestamp(
        "2026-08-28"
    )
    assert active_lm2_formation_date(pd.Timestamp("2026-08-31")) == pd.Timestamp(
        "2026-08-28"
    )
